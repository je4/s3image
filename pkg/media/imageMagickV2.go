...
type ImageMagickV2 struct {
	mw     *imagick.MagickWand
	frames int64
}

func NewImageMagickV2(reader io.Reader) (*ImageMagickV2, error) {
	im := &ImageMagickV2{mw: imagick.NewMagickWand()}
...
func (im *ImageMagickV2) Close() {
	im.mw.Destroy()
}

func (im *ImageMagickV2) LoadImage(reader io.Reader) error {
...
func (im *ImageMagickV2) StoreImage(format string) (io.Reader, *CoreMeta, error) {
...
func (im *ImageMagickV2) Resize(options *ImageOptions) error {
	im.mw.ResetIterator()
	im.frames = 0
	for im.mw.NextImage() {
		im.frames++
